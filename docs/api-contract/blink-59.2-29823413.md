...
| rest | `https://rest-{tier}.immedia-semi.com/api/` | 160 | bearer |
...
| POST | `oauth/token` | Oauth | none | — | com.immediasemi.blink.common.account.auth.RefreshTokensResponse | unchanged | direct | `com/immediasemi/blink/common/account/auth/OauthApi.java:26` |
...
| POST | `app/logs/upload` | Log | bearer | com.immediasemi.blink.api.retrofit.LogsBody | Unit | unchanged | direct | `com/immediasemi/blink/common/log/LogApi.java:19` |
...
- Active normalized contracts: 334
- Models recovered: 652
- Unresolved candidates: 373
